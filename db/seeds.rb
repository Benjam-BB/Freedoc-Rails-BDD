...
Specialty.create(name: "hématologie")
...
15.times do #en créer 10 
	Join.create!(specialty_id: Specialty.all.sample.id, doctor_id: Doctor.all.sample.id) #prend un parmis l'array all
end
puts "ok pour les docteurs/specialités"